...
Assume the setting of Theorem~\ref{thm-dil}, and suppose $\ell(\colsA+n)/B$ is negligible, $\SIS_{q,n,\colsA+\ell+n,\Bclip+B}$ holds, decision LWE holds at the parameters of the theorem, and the PRFs and $\iO$ are secure. Then the scheme $\DSScheme[\HF^{\mathsf{lio}}]$ is EUF-static secure.
\end{corollary}
