% Archived salted-Schnorr body material. This file is intentionally not input
% by main.tex. The active paper instead derives a public-randomness wrapper
% from the derandomized theorem in Corollary~\ref{cor-randomized-wrapper}.
