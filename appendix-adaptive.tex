...
\end{center}
\vspace{-6pt}
\caption{The temporary circuit $C_j$ used when changing the answer to query $j$. It is padded to the same fixed size bound $s'(\secp)$ as the published circuit.}\label{fig-circuit-query}
\vspace{-3pt}\hrulefill
\vspace{-1ex}
\end{figure}
